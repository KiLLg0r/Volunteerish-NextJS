...
const ClosedAnnounces = ({ initialAnnounces }) => {
  ...
  return (
    <Grid.Container gap={2}>
      <Head>
        <title>
          {languages[Language].closedAnnounces} | {languages[Language].headTags.title}
        </title>
      </Head>
      <Grid xs={12}>
        <Button
      ...
      <Grid xs={12}>
        <h2 className={styles.title}>{languages[Language].closedAnnounces}</h2>
      </Grid>
      {announces ? (
